    ...
    loader.load(
        ...
        function (group) {
            ...
            if (object.animations && object.animations.length) {
                ...
                if (currentAction) {
                    currentAction.fadeOut(1.0); // Transición más suave
                    newAction.reset().fadeIn(1.0).play();
                } else {
                    newAction.play();
                }
...
function updateAnimationLabel(name) {
    const label = document.getElementById('animationName');
    if (label) {
        label.textContent = 'Animación: ' + name;
